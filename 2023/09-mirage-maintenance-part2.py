...
def get_next(numbers) -> int:
    ...
    return new_numbers[0] if len(set(new_numbers)) == 1 else new_numbers[0] - get_next(new_numbers)


new_items = []
for line in input_data:
    numbers = list(map(int, line.split()))
    new_items.append(numbers[0] - get_next(numbers))
    # print(new_items[-1], new_items[-1] + numbers[0])
